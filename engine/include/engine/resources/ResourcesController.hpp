...
*/
    ...
    *
    * Other params, except name, are optional. If not provided the function will search for a mountain_skybox
    * in the: "resources/skyboxes".
    * Images for the sides of the mountain_skybox cube should be named: left.jpg, right.jpg, top.jpg, bottom.jpg, front.jpg, back.jpg (any supported image extension).
    * @param name of the mountain_skybox directory that contains 6 images for each side of the cube.
    * @param path form which to load the texture.
    * @param flip_uvs flip the uvs on load if set to true
